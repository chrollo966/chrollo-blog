...
type BlogPageQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly date: string | null, readonly title: string | null, readonly slug: string | null, readonly private: boolean | null } | null }> } };
...
type BlogPostQuery = { readonly mdx: { readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly hero_image_alt: string | null, readonly hero_image_credit_link: string | null, readonly hero_image_credit_text: string | null, readonly private: boolean | null, readonly hero_image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };
